...
//         <p className="text-[11px] sm:text-[13px] xl:pl-[24px] lg:pl-[24px] md:text-[15px] lg:text-[18px] xl:text-[26px] font-poppins font-normal leading-[1.5] md:leading-[1.7] tracking-normal mb-2 sm:mb-4 md:mb-4 lg:mb-4 xl:mb-12 opacity-90 max-w-[700px] text-left">
//           {description}
//         </p>
...
// const Card = ({ titleImg, title, description, image, bgColor, textColor, showLogin, btnColor, btnTextColor }) => {
//   return (
//     <div
//       // className={`service-card relative group w-full h-[360px] sm:h-[480px] md:h-[620px] lg:h-[600px] xl:h-[805px] rounded-[2.5rem] md:rounded-[4rem] rounded-tl-none md:rounded-tl-none pt-5 p-5 md:pt-14 md:p-16 flex flex-col justify-start overflow-hidden shadow-2xl ${bgColor} ${textColor} cursor-pointer origin-center will-change-transform`}
//       className={`service-card relative group w-full min-h-[260px] sm:min-h-[480px] md:min-h-[470px] lg:min-h-[440px] xl:min-h-[570px] rounded-[2.5rem] md:rounded-[4rem] rounded-tl-none md:rounded-tl-none pt-5 p-5 md:pt-14 md:px-16 md:pb-6 lg:pb-6 xl:pb-10 flex flex-col justify-between overflow-hidden shadow-2xl ${bgColor} ${textColor} cursor-pointer origin-center will-change-transform`}
...
//         {/* <div className="mb-3 md:mb-6 h-6 sm:h-8 md:h-12 lg:h-14 xl:h-16 w-auto flex items-center justify-start">
//           <HeadingH1 leading="0.6em" txtColor={textColor}>
//             {title}
//           </HeadingH1>
//         </div> */}
...
//         <div className="mb-3 md:mb-6 h-6 sm:h-8 md:h-12 lg:h-14 xl:h-16 w-auto flex items-center justify-start">
//           <h1
//             className="font-falcon font-bold tracking-tight text-[36px] sm:text-[48px] md:text-[64px] lg:text-[80px] xl:text-[100px]"
//             style={{ lineHeight: '0.6em', color: textColor }}
//           >
//             {title}
//           </h1>
//         </div>
...
//   const services = [
//     { titleImg: head1, title: "ILAAN Studio", head1, description: "Control every screen from one place. Keep content consistent, visible and across your entire network.", image: card1, bgColor: "bg-[#D9FF00]", textColor: "text-black", showLogin: true, btnColor: "bg-black", btnTextColor: "text-white" },
//     { titleImg: head2, title: "ILAAN Digital Signage", head2, description: "Displays built for commercial use. Reliable, high-performance screens designed for retail, QSR and high-traffic environments.", image: card2, bgColor: "bg-[#404040]", textColor: "text-[#D9FF00]", showLogin: false, btnColor: "bg-[#D9FF00]", btnTextColor: "text-black" },
//     { titleImg: head3, title: "ILAAN Link", head3, description: "Reduce manual work across your store. Update pricing instantly and eliminate repetitive tasks.", image: card3, bgColor: "bg-[#FFFF00]", textColor: "text-black", showLogin: true, btnColor: "bg-black", btnTextColor: "text-white" },
//     { titleImg: head4, title: "ILAAN Media", head4, description: "Access retail media in the real world. Run campaigns across a growing network of in-store screens.", image: card4, bgColor: "bg-[#FF33FF]", textColor: "text-white", showLogin: false, btnColor: "bg-black", btnTextColor: "text-white" }
//   ];
