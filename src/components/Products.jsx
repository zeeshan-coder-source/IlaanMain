...
//       className="product-card group relative flex flex-col p-7 sm:p-5 md:p-7 lg:p-5 xl:p-12 xl:pt-0 rounded-[2rem] md:rounded-[2.5rem] w-full cursor-pointer will-change-transform md:pb-10"
//       style={{
...
import p6 from '../assets/product/product6.png';
// import cardBg from '../assets/card-background.webp';
import cardBg from '../assets/Group 99 copy.png';
