...
import bg1 from '../assets/update/studioD.webp';
import bg2 from '../assets/update/digitalD.webp';
import bg3 from '../assets/update/linkD.webp';
import bg4 from '../assets/update/mediaD.webp';

import bg1Mobile from '../assets/update/studioM.webp';
import bg2Mobile from '../assets/update/digitalM.webp';
import bg3Mobile from '../assets/update/linkM.webp';
import bg4Mobile from '../assets/update/mediaM.webp';
...
const slideContents = [
  {
    ...
    subtitle: 'Deploy, Manage & Scale Your Screen Network'
  },
  {
    parts: [
    ...
    subtitle: 'Modernise Your Store. Engage Customers. Drive Sales.'
  },
  {
    parts: [
      { text: 'ILAAN ', color: '#ffffff' },
    ...
    subtitle: 'Keep Prices Right. Save Time. Cut Costs.'
  },
  {
    parts: [
      { text: 'ILAAN ', color: '#ffffff' },
    ...
    // subtitle: 'Creative & Branding Solutions'
    subtitle: 'Drive Awareness. Influence Purchase. Measure Impact.'
  }
];
            ...
            <div className="max-w-5xl mb-10 reveal-text">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="lg:ml-[-5px] py-2 md:py-2 flex items-start justify-start">
                    <HeadersH1 leading="0.1em" letterSpacing="-0.05em" parts={slide.parts} />
                  </div>

                  <p className="mt-3 md:mt-8 text-[13px] md:text-[25px] text-white font-poppins font-normal leading-[1.2] tracking-normal max-w-[200px] md:max-w-full">
                    {slide.subtitle}
                  </p>
                </motion.div>
              </AnimatePresence>
